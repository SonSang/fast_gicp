#ifndef WGICP_D_LSQ_REGISTRATION_HPP
#define WGICP_D_LSQ_REGISTRATION_HPP
...
class dLsqRegistration : public pcl::Registration<PointSource, PointTarget, float> {
public:
  using Scalar = float;
  ...
  using Ptr = pcl::shared_ptr<dLsqRegistration<PointSource, PointTarget>>;
  using ConstPtr = pcl::shared_ptr<const dLsqRegistration<PointSource, PointTarget>>;
#else
  using Ptr = boost::shared_ptr<dLsqRegistration<PointSource, PointTarget>>;
  using ConstPtr = boost::shared_ptr<const dLsqRegistration<PointSource, PointTarget>>;
#endif
