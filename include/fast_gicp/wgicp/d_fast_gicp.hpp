#ifndef WGICP_D_FAST_GICP_HPP
#define WGICP_D_FAST_GICP_HPP
...
class dFastGICP : public dLsqRegistration<PointSource, PointTarget> {
public:
  using Scalar = float;
  ...
  using Ptr = pcl::shared_ptr<dFastGICP<PointSource, PointTarget>>;
  using ConstPtr = pcl::shared_ptr<const dFastGICP<PointSource, PointTarget>>;
#else
  using Ptr = boost::shared_ptr<dFastGICP<PointSource, PointTarget>>;
  using ConstPtr = boost::shared_ptr<const dFastGICP<PointSource, PointTarget>>;
#endif
...
public:
  dFastGICP();
  virtual ~dFastGICP() override;

  void setNumThreads(int n);
  void setCorrespondenceRandomness(int k);
  void setRegularizationMethod(fast_gicp::RegularizationMethod method);
...
protected:
  ...
  fast_gicp::RegularizationMethod regularization_method_;
